...
\hhline{|-|-|-|-|-|-|}
	...
	{\gnumericPB{\centering}\gnumbox{\textbf{Number}}}
\\
\hhline{|------|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	...
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}\gnumbox{$n(X=0) = 100$}}
\\
\hhline{|------|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	...
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}\gnumbox{$n(X=1) = 50$}}
\\
\hhline{|------|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	...
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}\gnumbox{$n(X=2) = 20$}}
\\
\hhline{|------|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	...
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}\gnumbox{$n(X=3) = 10$}}
\\
\hhline{|-|-|-|-|-|-|}
\end{tabular}
